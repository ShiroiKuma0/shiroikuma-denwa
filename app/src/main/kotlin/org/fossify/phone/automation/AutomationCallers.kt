...
object AutomationCallers {
     ...
     */
    // Kept as a constant so the command travels with the map it explains and cannot rot into a
    // comment nobody updates; nothing reads it, which is exactly the point.
